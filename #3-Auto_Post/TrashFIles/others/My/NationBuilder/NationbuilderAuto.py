...
# url = "https://www.nyhcampaign.org/users/event_pages/new?parent_id=3817"
...
def EventPost(headline, venue, address1, address2, city, state, zip, description):
    ...
    _description_tiny = driver.find_element_by_id("event_page_content_editable_ifr")
    pc.copy(description)
