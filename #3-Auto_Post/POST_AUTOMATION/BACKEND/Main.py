...
from POST_AUTOMATION.NATIONBUILDER.Data import Data as Na_data
...
class NationBuilder():
    ...
    def CheckLogin():
        try:
            ...
            DC.enter_text(Na_Locator.EMAIL,Na_data.EMAIL)
            DC.enter_text(Na_Locator.PASSWORD,Na_data.PASSWORD)
