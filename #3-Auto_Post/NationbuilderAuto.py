...
def EventPost(headline, venue, address1, address2, city, state, zip, description):
    ...
    _headline = driver.find_element_by_xpath(
        '//input[@id="event_page_page_headline"]').send_keys(headline)
    try:
    ...
    _description_tiny = driver.find_element_by_xpath(
        '//iframe[@id="event_page_content_editable_ifr"]').send_keys(f" {description}")
